...
get_ipython().system('apt-get install protobuf-compiler python-pil python-lxml python-tk')
get_ipython().system('pip install Cython tf_slim')
...
get_ipython().run_line_magic('set_env', 'PYTHONPATH=/content/models/research:/content/models/research/slim')


# In[ ]:


get_ipython().system('python setup.py build')
...
get_ipython().system('python tf_record.py --csv_input=/content/models/research/content/images_v3_labels.csv --image_dir=/content/models/research/content/images_v3 --output_path=/content/tf_record/train.record')
...
get_ipython().run_cell_magic('capture', '', '!python train.py --logtostderr --train_dir="/content/drive/My Drive/pubg_v3/training_dir" --pipeline_config_path=faster_rcnn_inception_v2_coco.config')
...
get_ipython().system('python export_inference_graph.py --input_type image_tensor --pipeline_config_path faster_rcnn_inception_v2_coco.config --trained_checkpoint_prefix "/content/drive/My Drive/pubg_v3/training_dir/model.ckpt-50000" --output_directory /content/inference_graph')
